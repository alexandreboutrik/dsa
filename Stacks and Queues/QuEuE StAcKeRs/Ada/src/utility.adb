...
package body Utility is
    ...
    procedure Chega (Wqueue: in out Two_Queue; Ticket: String; Name: String) is
        P: Person;
    begin
        ...
        elsif Queue_Size(Wqueue(2)) >= Queue_Size(Wqueue(1)) OR 
        Queue_Is_Empty(Wqueue(1)) then
    ...
    begin
        ...
        Put(Nrange, Width => 0);
        Put(" ingresso(s) carregado(s) no guiche ");
        Put(Num, Width => 0);
        Put_Line(".");
    end;
